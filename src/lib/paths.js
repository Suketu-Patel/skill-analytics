...
// Cursor (the IDE) keeps its composer-session state in a per-user
// VSCode-style appdata directory. Mac path baked in; override via
// CURSOR_HOME for Linux/Windows or non-default installs.
